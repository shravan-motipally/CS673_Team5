...
const Settings = () => {
  ...
  const handleGenerativeModeToggle = () => {
    setScreenState({
      ...screenState,
          ...
          <Container maxWidth="sm" sx={{
            ...
            <FormControl component="fieldset" variant="standard">
              ...
              <FormGroup sx={{ margin: 2 }}>
                <FormControlLabel
                  control={
                    <Switch checked={screenState.generativeMode} onChange={handleGenerativeModeToggle} name="generativeMode" />
                  }
                  label="Allow Generative Mode"
                />
              </FormGroup>
              <FormHelperText>Generative Mode allows students to see answers generated by the {screenState.generativeModel} Model</FormHelperText>
            </FormControl>
